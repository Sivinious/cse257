...
def train_eval(envs, policy, args, test_args, log, j, total_num_steps, test_eval_envs, train_eval_envs):
...
def evaluate(args, policy, ob_rms, log, env_trans_fn, num_iters=0, verbose=False, num_render=None, train_mode='train', eval_envs=None):
