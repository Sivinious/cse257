...
def grid_args(args):
    ...
    set_if_none(args, 'num_processes', 16) #32
...
def create_args(args):
    set_if_none(args, 'num_processes', 8) # 32
...
def get_args(arg_str=None):
    ...
    parser.add_argument('--emb-batch-size', type=int, default=64) #128
