...
def get_env(args):
    ...
    env_1_args['K']                         = args.reco_prod_dim        # 16
...
class RecoEnv(ActionEnv):
    ...
    def set_args(self, args, set_eval):
        ...
        self.observation_space = spaces.Box(low=0.0, high=1.0, shape=(args.reco_prod_dim,), dtype=np.float32)
    ...
    def set_fixed_action_space(self, args, action_set):
        ...
        if args.reco_special_fixed_action_set_size is not None:
            ...
            sub_split   = rng.choice(sub_split, args.reco_special_fixed_action_set_size, replace=False)
